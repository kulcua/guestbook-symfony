 ...
 */
final class Version20201210085700 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE conference (id INT NOT NULL, city VARCHAR(255) NOT NULL, year VARCHAR(255) NOT NULL, is_international BOOLEAN NOT NULL, PRIMARY KEY(id))');
